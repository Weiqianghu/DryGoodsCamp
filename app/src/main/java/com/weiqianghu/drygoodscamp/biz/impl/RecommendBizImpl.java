...
import com.weiqianghu.drygoodscamp.biz.RecommendBiz;
 ...
 */
public class RecommendBizImpl extends BaseBiz<CategoryService> implements RecommendBiz {
    public static final String CATEGORY = "瞎推荐";
