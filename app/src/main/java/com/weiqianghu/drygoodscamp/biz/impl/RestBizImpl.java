...
import com.weiqianghu.drygoodscamp.biz.RestBiz;
 ...
 */
public class RestBizImpl extends BaseBiz<CategoryService> implements RestBiz {
    public static final String CATEGORY = "休息视频";
