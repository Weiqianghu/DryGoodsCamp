...
import com.weiqianghu.drygoodscamp.biz.ExpandBiz;
 ...
 */
public class ExpandBizImpl extends BaseBiz<CategoryService> implements ExpandBiz {
    public static final String CATEGORY = "扩展资源";
